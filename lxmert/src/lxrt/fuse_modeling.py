...
class LXRTEncoder(nn.Module):
    ...
    def forward(self, cls_lang_feats, lang_feats, lang_attention_mask,
        ...
        # combine with CLS language features
        # print("lang_feats", lang_feats.shape)
        lang_feats = lang_feats * cls_lang_feats
...
class LXRTModel(BertPreTrainedModel):
    ...
    def forward(self, cls_lang_feats, input_ids, token_type_ids=None, attention_mask=None,
        ...
        # Run LXRT backbone
        lang_feats, visn_feats = self.encoder(cls_lang_feats,
            embedding_output,
...
class LXRTFeatureExtraction(BertPreTrainedModel):
    ...
    def forward(self, cls_lang_feats, input_ids, token_type_ids=None, attention_mask=None, visual_feats=None,
                visual_attention_mask=None):
        feat_seq, pooled_output = self.bert(cls_lang_feats, input_ids, token_type_ids, attention_mask,
