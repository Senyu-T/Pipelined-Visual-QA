...
def parse_args():
    ...
    # Classifier params
    parser.add_argument("--cls_numlayer", type=int, default=2)
    parser.add_argument("--cls_numclasses", type=int, default=5)
    #
    parser.add_argument('--load_cls', default="/content/gdrive/MyDrive/lxmert/bert_sequence_classifier/lr_1e-05_bs_32_loss_ce_opt_adam/snapshot_val_best",type=str,help='Load the pre-trained Classifier model.')
    # for multitask loss, hyper parameter
    parser.add_argument("--alpha", type=float, default=1.0)
    parser.add_argument("--beta", type=float, default=1.0)

    # lstmcnn model config file
    parser.add_argument('--lstmcnn_path_config', default='lstmcnn_classifier/default.yaml', type=str,
