...
from tasks.vqa_model import FusionAfterCrossVQAModel, MultiLoss, FusionBothVQAModel, JointVQAModel, FusionBeforeCrossVQAModel, VQAModel
...
class VQA:
    def __init__(self):
        ...
        #self.model = FusionBeforeCrossVQAModel(self.train_tuple.dataset.num_answers)
        #self.model = FusionAfterCrossVQAModel(self.train_tuple.dataset.num_answers)
        #self.model = FusionBothVQAModel(self.train_tuple.dataset.num_answers)
        ...
        if args.load_cls is not None:
          self.model.classifier.load_state_dict(torch.load(args.load_cls)) 
        ...
        self.scheduler = optim.lr_scheduler.ReduceLROnPlateau(self.optim, factor=0.7, patience=2, verbose=True, mode='max')
        # Output Directory
    ...
    def train(self, train_tuple, eval_tuple):
        ...
        for epoch in range(args.epochs):
            ...
            for i, (ques_id, feats, boxes, sent, target, quesType) in iter_wrapper(enumerate(loader)):
                ...
                vqa_logit, cls_logit = self.model(feats, boxes, sent)
    ...
    def predict(self, eval_tuple: DataTuple, dump=None):
        ...
        for i, datum_tuple in enumerate(loader):
            ...
            with torch.no_grad():
                ...
                logit = self.model(feats, boxes, sent)[0]
